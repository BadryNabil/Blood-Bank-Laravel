  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url(route('posts.index'))}}"><i class="fa fa-comment"></i> Posts</a></li>
        <li><a href="{{url(route('categores.index'))}}"><i class="fa fa-list-alt"></i>Categories</a></li>
        <li><a href="{{url(route('governorates.index'))}}"><i class="fa fa-flag"></i> <span>Governorates</span></a></li>
        <li><a href="{{url(route('city.index'))}}"><i class="fa fa-flag-checkered"></i> <span>Cities</span></a></li>
